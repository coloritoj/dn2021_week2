...
namespace StudentDatase_ExtraChallenges
{
    /* ----- DIRECTIONS -----
    * 
    ...
    * 1 POINT: For the category names, allow uppercase and lowercase. Also, also allow a portion of the word such as "Food" instead of "Favorite Food".
    */
    class Program
    {
        static bool GoAgain()
